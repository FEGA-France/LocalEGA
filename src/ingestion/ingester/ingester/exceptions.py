...
class NotFoundInInbox(FromUser):
    ...
    def __repr__(self):
        return f'Inbox missing file: [{self.username}]{self.filename}'
...
class Crypt4GHPayloadError(FromUser):
    """Raised Exception when payload decryption/re-encryption fails."""

    def __str__(self):
        return 'Error decrypting/re-encrypting the content of this file'
